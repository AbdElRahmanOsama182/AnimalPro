...
animals([
        ...
        animal(ostrich, [is_true("is omnivore"), is_true("is large"), is_true("does it run"), is_true("has feathers"), is_true("is wild"), is_true("booms")]),
        ...
        animal(monkey, [is_true("is omnivore"), is_true("is regular-sized"), is_true("does it climb"), is_true("has fur"), is_true("is wild"), is_true("chatters")]),
        ...
        animal(hedgehog, [is_true("is omnivore"), is_true("is small"), is_true("does it crawl"), is_true("has spines"), is_true("is wild"), is_true("snuffle")]),
        ...
        animal(eagle, [is_true("is carnivore"), is_true("is large"), is_true("does it fly"), is_true("has feathers"), is_true("is wild"), is_true("screeches")]),
        ...
        animal(owl, [is_true("is carnivore"), is_true("is small"), is_true("does it fly"), is_true("has feathers"), is_true("is wild"), is_true("hoot")]),
        ...
        animal(hippopotamus, [is_true("is herbivore"), is_true("is huge"), is_true("does it swim & run"), is_true("has skin"), is_true("is wild"), is_true("grunt")]),
        ...
        animal(kangaroo, [is_true("is herbivore"), is_true("is large"), is_true("does it hop"), is_true("has fur"), is_true("is wild"), is_true("chortle")]),
        ...
        animal(hummingbird, [is_true("is herbivore"), is_true("is tiny"), is_true("does it fly"), is_true("has feathers"), is_true("is wild"), is_true("hum")])
        ]).
